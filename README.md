Day 1: Im doing this to achieve consistency Day 1 content : variable, function, scope, datatype, round, retun, split, title, capatilize, strip, end,sep, f stringn, input, _, match, conditionals (if,elif,else, or and not )
